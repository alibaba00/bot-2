...
export const logSystem = () => {
	const log = (...val) => {	//colorized log output
...
//----------------------------------------------------------------------------- getBrowser
export const getBrowser = () => {		//https://developer.mozilla.org/en-US/docs/Web/API/Window/navigator
...
//----------------------------------------------------------------------------- getDevice
export const getDevice = () => {		//https://dev.to/itsabdessalam/detect-current-device-type-with-javascript-490j
